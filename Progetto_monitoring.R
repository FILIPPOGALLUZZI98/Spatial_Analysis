...
m <- c(0, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1) 
par(mfrow=c(2,3))
vegc18 <- classify(veg18, m) 
plot(vegc18, col = rev(terrain.colors(7)), main = 'Vegetation 2018')
vegc19 <- classify(veg19, m) 
plot(vegc19, col = rev(terrain.colors(7)), main = 'Vegetation 2019')
vegc20 <- classify(veg20, m) 
plot(vegc20, col = rev(terrain.colors(7)), main = 'Vegetation 2020')
vegc21 <- classify(veg21, m) 
plot(vegc21, col = rev(terrain.colors(7)), main = 'Vegetation 2021')
vegc22 <- classify(veg22, m) 
plot(vegc22, col = rev(terrain.colors(7)), main = 'Vegetation 2022')
vegc23 <- classify(veg23, m) 
plot(vegc23, col = rev(terrain.colors(7)), main = 'Vegetation 2023')


cl<-colorRampPalette(c("black","ivory2","sandybrown","palegreen1","olivedrab3","dark green"))(6)
m <- c(-1,0,0.2, 0.4, 0.6, 0.8, 1) 
par(mfrow=c(2,3))
vegc18 <- classify(veg18, m) 
plot(vegc18, col = cl, main = 'Vegetation based thresholding 2018')
vegc19 <- classify(veg19, m) 
plot(vegc19, col = cl, main = 'Vegetation based thresholding 2019')
vegc20 <- classify(veg20, m) 
plot(vegc20, col = cl, main = 'Vegetationbased thresholding 2020')
vegc21 <- classify(veg21, m) 
plot(vegc21, col = cl, main = 'Vegetationbased thresholding 2021')
vegc22 <- classify(veg22, m) 
plot(vegc22, col = cl, main = 'Vegetationbased thresholding 2022')
vegc23 <- classify(veg23, m) 
plot(vegc23, col = cl, main = 'Vegetationbased thresholding 2023')
